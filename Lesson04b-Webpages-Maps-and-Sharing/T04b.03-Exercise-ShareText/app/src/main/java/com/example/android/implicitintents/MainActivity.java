...
String text = "Hello World!!";
    ...
    // DONME (1) Create a void method called shareText that accepts a String as a parameter
    ...
    private void shareText(String text){
        ...
        Intent intent = ShareCompat.IntentBuilder.from(this).setType(mimeType).setChooserTitle(title).setText(text).getIntent();
        startActivity(intent);
