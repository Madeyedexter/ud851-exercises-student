...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        String boardingtime = simpleDateFormat.format(info.boardingTime);
        String departureTime = simpleDateFormat.format(info.departureTime);
        String arrivalTime = simpleDateFormat.format(info.arrivalTime);
        ...
        long minutesLessHoursUntilBoarding = minutesToBoarding - TimeUnit.HOURS.toMinutes(hoursToBoarding);
        String hoursUntilBoarding = getString(R.string.countDownFormat, hoursToBoarding, minutesLessHoursUntilBoarding);
        binding.textViewBoardingInCountdown.setText(hoursUntilBoarding);
