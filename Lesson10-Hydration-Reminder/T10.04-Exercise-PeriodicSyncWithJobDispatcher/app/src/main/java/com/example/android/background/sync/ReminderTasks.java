...
public class ReminderTasks {
    ...
    public static final String ACTION_REMIND_CHARGING = "charging-notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        } else if (ACTION_REMIND_CHARGING.equals(action)){
            issueChargingReminderAction(context);
        }
    }
    ...
    public static void issueChargingReminderAction(Context context){
